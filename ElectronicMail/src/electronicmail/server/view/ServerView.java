 ...
 */
package electronicmail.server.view;

import electronicmail.server.controller.*;
...
public class ServerView extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        serverLoader.setLocation(this.getClass().getResource("/electronicmail/server/fxml/FXMLServer.fxml"));
